# Screenshots for the Features page

Drop your captured images in **this folder** using the **exact filenames** below
(all lowercase, `.png`). The Features page (`features.html`) references these names,
and shows a placeholder box for any that aren't here yet - so nothing breaks if one
is missing.
